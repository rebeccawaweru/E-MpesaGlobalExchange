...
export default function Neteller({sign ,id}){
    ...
    return(
        <>
         <Typography variant='h5' component="h4">Neteller</Typography>
       ...
       <CustomModal handleClose={()=>setOpen11(false)} title="CONFIRM"
        ...
        <CustomModal handleClose={()=>setOpen9(false)} open={open9}
         content={
          <>
          Deposit USD To Mobile Number: 
          <CustomTextField value="+254789333444"/><Button sx={{mx:2,mt:1}} onClick={() => navigator.clipboard.writeText("+254789333444")} variant="contained">Copy</Button>
          </>
         }/>
        ...
        <CustomModal handleClose={()=>setOpen8(false)} title="Withdraw Account"
         content={<>
          ...
          <input type="radio" value="Neteller" onChange={(e)=>setMethod(e.target.value)} />Neteller<br></br>
          ...
          <CustomTextField label="Neteller Account" value={accounttypenumber2} handleChange={(e)=>setAccounttypenumber2(e.target.value)}  />
          <br></br>
       ...
       {/* stop */}
        ...
        <CustomContent image={neteller} width="200" height={380}>
          <Typography component="h5" variant="h5" sx={{fontSize:30}}>Sell</Typography>
          <Typography component="h5" variant="h5" sx={{fontSize:30}}>Neteller</Typography>
