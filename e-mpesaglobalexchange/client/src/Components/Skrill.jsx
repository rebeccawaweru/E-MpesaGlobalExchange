...
export default function Skrill({sign ,id}){
    ...
    return(
        <>
         <Typography variant='h5' component="h4">Skrill</Typography>
       ...
       <CustomModal handleClose={()=>setOpen11(false)} title="CONFIRM"
        ...
        <CustomModal handleClose={()=>setOpen8(false)} title="Withdraw Account"
         content={<>
          ...
          <input type="radio" value="Skrill" onChange={(e)=>setMethod(e.target.value)} />Skrill<br></br>
          ...
          <CustomTextField label="Skrill Account" value={accounttypenumber2} handleChange={(e)=>setAccounttypenumber2(e.target.value)}  />
          <br></br>
       ...
       {/* stop */}
        ...
        <CustomContent image={skrill} width="200" height={380}>
          <Typography component="h5" variant="h5" sx={{fontSize:30}}>Sell</Typography>
          <Typography component="h5" variant="h5" sx={{fontSize:30}}>Skrill</Typography>
          <hr style={{marginLeft:5}}></hr>
          <CustomModal handleClose={()=>setOpen3(false)} title="Binary Account"
         content={<>
          {error && <Alert color='error'>{error}</Alert>}
